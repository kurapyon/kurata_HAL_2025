...
static char *g_TextureName[] =
{
	...
	"data/TEXTURE/f01.png",
	"data/TEXTURE/f02.png",
	"data/TEXTURE/f03.png",
	"data/TEXTURE/f04.png",
	"data/TEXTURE/f05.png",
	"data/TEXTURE/f06.png",
	"data/TEXTURE/f07.png",
...
HRESULT InitTree(void)
{
	...
	// 木の設定
	SetTree(XMFLOAT3( 600.0f, 0.0f,  600.0f), 10.0f, 10.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3( 600.0f, 0.0f,  400.0f), 10.0f, 10.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3( 600.0f, 0.0f,  200.0f), 10.0f, 10.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3( 600.0f, 0.0f,    0.0f), 10.0f, 10.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3( 600.0f, 0.0f,	   0.0f), 10.0f, 10.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3( 600.0f, 0.0f, -200.0f), 10.0f, 10.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3( 600.0f, 0.0f, -400.0f), 10.0f, 10.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3( 600.0f, 0.0f, -600.0f), 10.0f, 10.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
...
void DrawTree(void)
{
	...
	for(int i = 0; i < MAX_TREE; i++)
	{
		if(g_aTree[i].use)
		{
			...
			// スケールを反映
			mtxScl = XMMatrixScaling(g_aTree[i].scl.x * TREE_SIZE, g_aTree[i].scl.y * TREE_SIZE, g_aTree[i].scl.z * TREE_SIZE);
