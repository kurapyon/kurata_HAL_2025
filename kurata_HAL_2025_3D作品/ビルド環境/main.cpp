...
#define WINDOW_NAME		"GP11A132 09 倉田勇次"	// ウインドウのキャプション名
...
void Update(void)
{
	...
	case MODE_CLEAR_RESULT:		// リザルト画面の更新
		UpdateResult();
		break;

	case MODE_GAMEOVER_RESULT:
		// ゲームオーバー画面の更新
		UpdateGameOver();
		break;
...
void Draw(void)
{
	...
	case MODE_CLEAR_RESULT:		// リザルト画面の描画
		SetViewPort(TYPE_FULL_SCREEN);
