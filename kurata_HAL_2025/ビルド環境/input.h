...
// デフォルトのナンバー
#define Default_Game_Pad_Number	(0)
...
/* game pad情報 */
#define L_STICK_UP		0x00000001l	// 方向キー上(.IY<0)
#define L_STICK_DOWN	0x00000002l	// 方向キー下(.IY>0)
#define L_STICK_LEFT	0x00000004l	// 方向キー左(.IX<0)
#define L_STICK_RIGHT	0x00000008l	// 方向キー右(.IX>0)

// 右スティック
#define R_STICK_UP		0x00010000l	// 方向キー上(.lRz<0)
#define R_STICK_DOWN	0x00020000l	// 方向キー下(.lRz>0)
#define R_STICK_LEFT	0x00040000l	// 方向キー左(.lZ<0)
#define R_STICK_RIGHT	0x00080000l	// 方向キー右(.lZ>0)

// 十字キー
#define STICK_UP		0x00100000l	// 方向キー上(.IY<0)
#define STICK_DOWN		0x00200000l	// 方向キー下(.IY>0)
#define STICK_LEFT		0x00400000l	// 方向キー左(.IX<0)
#define STICK_RIGHT		0x00800000l	// 方向キー右(.IX>0)
...
// どのキーが押されているか
DIJOYSTATE2 GetDeviceState(int num = Default_Game_Pad_Number);
